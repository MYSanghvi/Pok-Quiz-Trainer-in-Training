...
Every Trainer must start somewhere.

Our future baby will eventually learn Pokémon, so this quiz is the first step in that journey. For now, the training responsibility falls on my wife.
